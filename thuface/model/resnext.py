...
class ResNeXt(nn.Module):
    ...
    def __init__(self, baseWidth, cardinality, layers, num_classes):
        ...
        # self.avgpool = nn.AvgPool2d(7)  # used for input image size=224
        self.avgpool = nn.AvgPool2d(14) # used for input image size=448
...
def resnext101(baseWidth, cardinality, num_classes):
    ...
    """
    model = ResNeXt(baseWidth, cardinality, [3, 4, 23, 3], num_classes=num_classes)
    return model
...
def resnext152(baseWidth, cardinality, num_classes):
    ...
    """
    model = ResNeXt(baseWidth, cardinality, [3, 8, 36, 3], num_classes=num_classes)
    return model
